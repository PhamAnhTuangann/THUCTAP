...
import Muiten from './HinhQLGSMHeader/Right.png';
import DropDown from './HinhQLGSMHeader/Down.png';

import './QLGSMHeader.css'
...
export default function BCATMHeader() {
    return (
        <div className="">
            ...
            <img src={Muiten} alt="" className="IconMuitenQLTBGSM"/>
