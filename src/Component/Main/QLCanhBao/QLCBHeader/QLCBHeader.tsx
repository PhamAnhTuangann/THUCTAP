    ...
    return(
        <div>
            ...
            <div>
                ...
                <p className="TitleLoaiCB">Loại cảnh báo:</p>
                <div className="bgTatCa1">
                    <img src={Nutxuong} alt="" className="IconDown1"/>
                    <p className="TitleTatCa">Tất cả</p>
                </div>


                <p className="TitleTrangThai">Trạng thái:</p>
                ...
                <button type="button" className="btnbgTimKiem">
